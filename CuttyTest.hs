...
processStream agg stream windowSize slideSize sessionGap =
  ...
  where
    ...
    -- Updating the slices for sliding windows
...
-- Efficiently storing slices with cleanup for expired windows here
...
-- now, Aggregate Sharing Implementation
...
-- Sliding and Session Window Aggregation
